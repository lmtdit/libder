...
var Tools, _, _modName, _paths, amdclean, build, color, fs, gulp, gutil, jsCtl, less, mincss, path, pkg, plumber, rename, rjs, setting, uglify, watch,
  ...
  less2js: function(cb) {
    ...
    _less = function(lessFile, cb) {
      ...
      return gulp.src(lessFile).pipe(plumber({
        ...
        return _source[_fileName] = output.contents.toString();
      }).on('end', function() {
